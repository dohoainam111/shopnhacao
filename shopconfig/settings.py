...
SECRET_KEY = 'django-insecure-k8t^@uu@w_o*b7qg*(*x9je!&-2=pl^#=8pa+8g1$(24$#4w$u'
...
# Media files (ảnh sản phẩm do admin upload)
MEDIA_URL = 'media/'
MEDIA_ROOT = BASE_DIR / 'media'

DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'

# django-ratelimit: nếu vượt quá giới hạn thì không raise lỗi 403 mà để view tự xử lý
RATELIMIT_VIEW = None

# Với project nhỏ 1 process, cache bộ nhớ (locmem) là đủ dùng cho rate limit.
